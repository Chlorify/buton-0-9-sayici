...
/* Private defines -----------------------------------------------------------*/
#define buton1_Pin GPIO_PIN_0
#define buton1_GPIO_Port GPIOA
#define buton2_Pin GPIO_PIN_3
#define buton2_GPIO_Port GPIOA
#define led_c_Pin GPIO_PIN_10
#define led_c_GPIO_Port GPIOB
#define led_dot_Pin GPIO_PIN_11
#define led_dot_GPIO_Port GPIOB
...
#define trs_7seg_Pin GPIO_PIN_15
#define trs_7seg_GPIO_Port GPIOA
#define led_d_Pin GPIO_PIN_8
#define led_d_GPIO_Port GPIOB
#define led_e_Pin GPIO_PIN_9
